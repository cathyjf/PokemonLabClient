...
public class TeamBuilderForm extends javax.swing.JPanel {
    ...
    //The current species
    private PokemonSpecies m_species;
    //index of this tab
    private int m_idx;
    ...
    public void setPokemon(Pokemon p, boolean loading) {
        if (loading) {
            cmbPokemon.setSelectedIndex(p.speciesId);
        }
        txtNickname.setText(p.nickname);
        cmbItem.setSelectedIndex(p.item);
        cmbNature.setSelectedIndex(p.nature);
        txtLevel.setText(String.valueOf(p.level));
        chkShiny.setSelected(p.shiny);
        cmbAbility.setSelectedIndex(p.ability);
        ...
        PokemonSpecies species = m_parent.getSpecies(p.speciesId);
        for (int i = 0; i < Pokemon.STAT_COUNT; i++) {
            m_bases[i].setText(String.valueOf(species.getBase(i)));
        }

        tblMoves.setModel(new MoveTableModel(m_parent.getMoveList(), species.getMoves()));
        tblMoves.getColumnModel().getColumn(1).setPreferredWidth(160);
        cmbAbility.setModel(new DefaultComboBoxModel(species.getAbilities()));

        m_parent.updateTitle(m_idx, species.getName());
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                .add(jLabel25)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(cmbHiddenPower, 0, 0, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(jPanel2Layout.createSequentialGroup()
                        ...
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            .add(evSpd, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(evSpAtk, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(evSpDef, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(evHp, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(evAtk, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(evDef, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                    .add(jPanel2Layout.createSequentialGroup()
                        .add(jLabel4)
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(scrollMoves, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 391, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void cmbPokemonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbPokemonItemStateChanged
        ...
        setPokemon(new Pokemon(idx, "", false, Gender.GENDER_MALE, 100, 0, 0, 0, new int[] {-1,-1,-1,-1},
